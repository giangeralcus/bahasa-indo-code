...
|---|---|---|
| Sapaan | kamu / Anda (pilih satu, konsisten) | lu / kamu |
| Dirinya | saya | gw / aku / saya |
...
|---|---|---|
| file, folder | berkas, berkas komputer, map | "berkas" sah di docs pemerintah/formal |
...
| diupload | diunggah (baku), di-upload (sah) | konsisten pilih satu bentuk |
